...
class handler(requestsManager.asyncRequestHandler):
	...
	def asyncGet(self):
		...
		html += "      _/_/    _/                    _/                          _/        _/   <br>"
		html += "   _/    _/  _/  _/      _/_/_/  _/_/_/_/    _/_/_/  _/    _/  _/  _/          <br>"
		html += "  _/_/_/_/  _/_/      _/    _/    _/      _/_/      _/    _/  _/_/      _/     <br>"
		html += " _/    _/  _/  _/    _/    _/    _/          _/_/  _/    _/  _/  _/    _/      <br>"
		html += "_/    _/  _/    _/    _/_/_/      _/_/  _/_/_/      _/_/_/  _/    _/  _/       <br>"
		html += "<b>ok lets be honest here, python sucks.. i still like it tho cuz i suck at coding</b><br><br>"
		html += "<marquee style='white-space:pre;'><br>"
		html += "                          .. o  .<br>"
		html += "                         o.o o . o<br>"
		html += "                        oo...<br>"
		html += "                    __[]__<br>"
		html += "    cmyui--> _\\:D/_/o_o_o_|__     <span style=\"font-family: 'Comic Sans MS'; font-size: 8pt;\">u wot m8</span><br>"
		html += "             \\\"\"\"\"\"\"\"\"\"\"\"\"\"\"/<br>"
		html += "              \\ . ..  .. . /<br>"
		html += "^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^<br>"
		html += "</marquee><br><strike>reverse engineering a protocol impossible to reverse engineer since always</strike><br>we are actually reverse engineering bancho successfully. for the third time.<br><br><i>&copy; Ripple and Akatsuki teams, 2018</i></pre></body></html>"
		self.write(html)