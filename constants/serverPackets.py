...
def loginBanned():
	...
	packets += notification("You are banned. Akatsuki does not currently officially allow players to appeal their bans. I hope whatever you did was worth it.")
	return packets

def loginLocked():
	packets = packetHelper.buildPacket(packetIDs.server_userID, [[-1, dataTypes.SINT32]])
	packets += notification("Your account is locked. You can't log in, but your profile and scores are still visible from the website. Akatsuki does not currently officially allow players to appeal their bans. I hope whatever you did was worth it.")
	return packets
