...
from pubSubHandlers import rxupdateStatsHandler
...
if __name__ == "__main__":
	...
	try:
		...
		# Start fokabot
		consoleHelper.printNoNl("> Connecting {}... ".format(glob.BOT_NAME))
		fokabot.connect()
		consoleHelper.printDone()
		...
		pubSub.listener(glob.redis, {
			...
			"peppy:update_rxcached_stats": rxupdateStatsHandler.handler(),
